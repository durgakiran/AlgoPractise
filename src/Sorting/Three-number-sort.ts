/**
 * Problem: You're given an array of integers and another array of three distinct integers. 
 ...
 * first array won't necessarily contain all three integers found in the second array—it might only contain one or two.
 * 
 * Example:
 ...
 * [0, 0, 0, 1, 1, 1, -1, -1]
 * 
 * counts = [..generatezerosEqualtoOrder()]
 * for ele in array
 *  - count number of time each element there
 * 
 * 
 * 
 */

export default function ThreeNumberSort() {
